...
folder are mapped to the application's root namespace, 'KirwanHighPBS'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "KirwanHighPBS"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'KirwanHighPBS' in the same way
as `"KirwanHighPBS/sass/src"`.
